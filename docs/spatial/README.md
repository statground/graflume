...
The SVG previews in these guides are generated by `scripts/render-spatial-snapshots.mjs` from the same compiled geometry used by the GPU renderer. The browser gallery runs the real WebGL renderer and its controls.
