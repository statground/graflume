...
## Capability matrix for all 37 families
...
| [Histogram](./histogram.md)                     | Yes                | Yes        | Yes | **Do not generic-filter by default.** Each frame re-bins the filtered sample and may move both bin and count domains.                                             |
...
| [Radar](./radar.md)                             | Yes                | Yes        | Yes | Snapshot only with a complete indicator set per frame; partial frames produce a different polygon meaning.                                                        |
...
| [Boxplot](./boxplot.md)                         | Yes                | Yes        | Yes | Snapshot only for complete precomputed five-number summaries; generic filtering does not recompute raw-sample statistics.                                         |
