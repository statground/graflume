...
![Current Vector field chart output](../assets/charts/vector.svg)
...
vector('#chart', data, {
  ...
  title: {
    ...
    subtitle: 'cartesian · vector',
  },
  accessibility: {
    label: 'Vector field chart example',
    description: 'A compiled vector field chart example using the vector family.',
  },
});
```
