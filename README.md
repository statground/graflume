...
- an ordered built-in theme catalog with polished light/dark designs, a `ggplot` profile matching
  ggplot2 `theme_gray()`, an R 4.6.1 base-graphics profile, and custom theme registration
