...
const budgets = [
  // 2026-08-27 measured raw minified bytes after row-cardinality evidence, topology-safe
  // areas, and collision-safe bar-family layout: 1,126,909 / 1,324,133 / 396,947.
  ...
  ['graflume.spatial.min.js', 388 * 1024],
];
