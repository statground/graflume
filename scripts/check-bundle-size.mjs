...
const budgets = [
  // 2026-09-06 measured after bounded native embedded PNG/JPEG image scenes:
  // 1,247,042 / 1,445,431 / 397,648 raw minified bytes.
  ...
  ['graflume.min.js', 1_218 * 1024],
  ['graflume.complete.min.js', 1_412 * 1024],
